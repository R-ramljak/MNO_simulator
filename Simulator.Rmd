...
contour.complete.MI <- contour.data.summary %>% 
  ...
  theme_minimal() +
  labs(x = "", y = "")
ggsave("coverage_contur/complete.MI.finer.png", contour.complete.MI, device = "png")
...
True P matrix for toy world generation
